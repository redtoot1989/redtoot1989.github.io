    ...
    class FormValidators {
        ...
        validateUrl(url) {
            try {
                ...
                return { isValid: parsed.protocol === "https:", message: parsed.protocol === "https:" ? "" : "الرابط يجب أن يبدأ بـ https://" };
            } catch {
        ...
        validateProfile(profile) {
            const errors = [];
            if (!profile.platform || !this.config.platforms?.[profile.platform]) errors.push("اختر منصة صحيحة");
