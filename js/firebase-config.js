...
(function (window) {
    ...
    function initServices(app) {
        ...
        // FIRESTORE is optional on lightweight auth-only pages.
        services.db = firebase.firestore ? firebase.firestore(app) : null;

        // STORAGE is optional; several pages only load app/auth/firestore.
        services.storage = firebase.storage ? firebase.storage(app) : null;
    ...
    async function initializeFirebase() {
        try {
            ...
            if (services.db) configureFirestore(services.db);
